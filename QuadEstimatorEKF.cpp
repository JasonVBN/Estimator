...
MatrixXf QuadEstimatorEKF::GetRbgPrime(float roll, float pitch, float yaw)
{
  ...
  // Refer to equation 52 in "Estimation for Quadrotors"
...
void QuadEstimatorEKF::Predict(float dt, V3F accel, V3F gyro)
{
  ...
  // For gPrime - Refer to equations 50-51 in "Estimation for Quadrotors"
...
void QuadEstimatorEKF::UpdateFromGPS(V3F pos, V3F vel)
{
  ...
  // For hPrime - refer to equation 55 in "Estimation for Quadrotors"
...
void QuadEstimatorEKF::UpdateFromMag(float magYaw)
{
  ...
  // For hPrime - refer to equation 58 in "Estimation for Quadrotors"
  hPrime(0, 6) = 1;
